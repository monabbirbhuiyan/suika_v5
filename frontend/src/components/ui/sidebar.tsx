...
function Sidebar({
  ...
  collapsible?: "offcanvas" | "icon" | "none" | boolean;
}) {
  const { isMobile, state, openMobile, setOpenMobile } = useSidebar();

  // Normalize collapsible to supported string values
  const normalizedCollapsible =
  ...
  return (
    <div
      ...
      data-state={state}
      data-collapsible={state === "collapsed" ? normalizedCollapsible : ""}
